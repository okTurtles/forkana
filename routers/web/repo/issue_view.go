...
func preparePullViewReviewAndMerge(ctx *context.Context, issue *issues_model.Issue) {
	...
	// Forkana: merging is a single step and the merge commit message is generated by the
	// merge handler, so no default merge title/body is computed for the view any more.
