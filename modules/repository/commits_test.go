...
func TestPushCommits_ToAPIPayloadCommits(t *testing.T) {
	...
	assert.Equal(t, "https://try.gitea.io/article/user2/repo16?version=69554a6", payloadCommits[0].URL)
	...
	assert.Equal(t, "https://try.gitea.io/article/user2/repo16?version=27566bd", payloadCommits[1].URL)
	...
	assert.Equal(t, "https://try.gitea.io/article/user2/repo16?version=5099b81", payloadCommits[2].URL)
	...
	assert.Equal(t, "https://try.gitea.io/article/user2/repo16?version=69554a6", headCommit.URL)
