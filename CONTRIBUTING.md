...
## Original Gitea Contributing Guidelines

For historical and reference purposes, and as a method for addressing questions not answered by this document, it may be useful to consult [Gitea's contributing guidelines](https://github.com/go-gitea/gitea/blob/main/CONTRIBUTING.md), as this project is a fork of the Gitea codebase.
