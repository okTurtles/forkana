...
<template>
  ...
  * Method 1: manually set some variables in pull_merge_box.tmpl, eg: {{$notAllOverridableChecksOk = true}} {{$canMergeNow = false}}
  * Method 2: make a protected branch, then set state=pending/success :
  ...
  <div>
    ...
    <div class="tw-flex">
      <!--
      Forkana: merging is a single step - the visible button submits the form directly.
      The merge title and message are generated by the server, so no title/message fields
      are sent and there is no intermediate "edit the merge commit message" step.
      another similar form is in pull_merge_box.tmpl (manual merge)
      -->
      <form class="ui form form-fetch-action" :action="mergeForm.baseLink + '/merge'" method="post">
        ...
        <div
          ...
          :class="[mergeForm.emptyCommit ? '' : mergeButtonStyleClass]"
        >
          <button class="ui button" type="submit" name="do" :value="mergeStyle">
          ...
          <div
            ...
            @click.stop.prevent="showMergeStyleMenu = !showMergeStyleMenu"
          >
            ...
            <div class="menu" :class="{ 'show': showMergeStyleMenu }">
              <template v-for="msd in mergeForm.mergeStyles">
                ...
                <div
                  ...
                  @click.stop.prevent="switchMergeStyle(msd.name)"
                >
                  <div class="action-text">
                    {{ msd.textDoMerge }}
                  </div>
                  <div
                    v-if="!msd.hideAutoMerge" class="auto-merge-small"
                    @click.stop.prevent="switchMergeStyle(msd.name, true)"
                  >
